...
export const translations = {
  en: {
    ...
    nav: {
      ...
      notificationsNote: "Analysis updates will appear here.",
      profileTitle: "Workspace overview",
      profileNote:
    ...
    home: {
      ...
      awaitingLiveAnalysis: "Analyze a location to view results.",
      ...
      latestAnalysisReady: "Latest analysis loaded",
      ...
      readyTitle: "Review agricultural intelligence from one dashboard",
      readySubtitle:
        "Use the interactive map to review climate, soil, and seasonal agricultural risk insights.",
      ...
      irrigationPending: "Analyze a location to view irrigation guidance.",
    ...
    map: {
      ...
      riskPlaceholder: "Analyze a location to view seasonal agricultural alerts.",
      noMajorRisks:
  ...
  ar: {
    ...
    nav: {
      ...
      notificationsNote: "ستظهر تحديثات التحليل هنا.",
      profileTitle: "نظرة عامة على مساحة العمل",
      profileNote: "أدوات الخريطة والتقرير والتحليل متاحة من التنقل الرئيسي.",
    ...
    home: {
      ...
      awaitingLiveAnalysis: "حلّل موقعاً لعرض النتائج.",
